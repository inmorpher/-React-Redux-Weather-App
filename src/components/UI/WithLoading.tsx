...
import ErrorElement from './SkeletonLoader/Error';
 ...
 */
const withLoading = <P extends object, T = never>(
	...
	const WithLoading: React.FC<P> = (props) => {
		...
		if (status === 'error') return <ErrorElement />;

		if ((useDataHook && data === undefined) || (useDataHook && data === null))
			return <ErrorElement />;
